    ...
    pub fn decode(fmt: RawFormat) -> Option<Self> {
        ...
        Some(match fmt {
            ...
            I {
                ...
                (0b00100, 0b000) => Inst::Addi { rd, rs1, imm: sext(imm as u64, 11) as i64 },
                (0b00110, 0b000) => Inst::Addiw { rd, rs1, imm: sext(imm as u64, 11) as i64 },
            ...
            S {
                ...
                (0b01000, 0b000) => Inst::Sb { rs1, rs2, offset: sext(imm as u64, 11) as i64 },
            ...
            B {
                ...
                (0b11000, 0b000) => Inst::Beq { rs1, rs2, offset: sext((imm as u64) << 1, 12) as i64 },
            ...
            U {
                ...
                0b01101 => Inst::Lui { rd, imm: ((imm as i32) << 12) as i64 },
