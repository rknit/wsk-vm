...
pub enum Inst {
    ...
    Fence { rd: u8, rs1: u8, imm: i64 },
    FenceI { rd: u8, rs1: u8, imm: i64 },
    Csrrw { rd: u8, rs1: u8, imm: i64 },
    Csrrs { rd: u8, rs1: u8, imm: i64 },
    Csrrc { rd: u8, rs1: u8, imm: i64 },
    Csrrwi { rd: u8, rs1: u8, imm: i64 },
    Csrrsi { rd: u8, rs1: u8, imm: i64 },
    Csrrci { rd: u8, rs1: u8, imm: i64 },
    Ecall { rd: u8, rs1: u8, imm: i64 },
    Ebreak { rd: u8, rs1: u8, imm: i64 },
    Uret { rd: u8, rs1: u8, imm: i64 },
    Sret { rd: u8, rs1: u8, imm: i64 },
    Mret { rd: u8, rs1: u8, imm: i64 },
    Wfi { rd: u8, rs1: u8, imm: i64 },
...
impl Inst {
    pub fn decode(fmt: RawFormat) -> Option<Self> {
        ...
        Some(match fmt {
            R {
                ...
                (0b11100, 0b000, 0b0001001) => Inst::SfenceVma { rd, rs1, rs2 },
            ...
            I {
                ...
                (0b00011, 0b000) => Inst::Fence {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b00011, 0b001) => Inst::FenceI {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b001) => Inst::Csrrw {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b010) => Inst::Csrrs {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b011) => Inst::Csrrc {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b101) => Inst::Csrrwi {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b110) => Inst::Csrrsi {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b111) => Inst::Csrrci {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b000) if imm == 0b000000000000 => Inst::Ecall {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b000) if imm == 0b000000000001 => Inst::Ebreak {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b000) if imm == 0b000000000010 => Inst::Uret {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b000) if imm == 0b000100000010 => Inst::Sret {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b000) if imm == 0b001100000010 => Inst::Mret {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
                (0b11100, 0b000) if imm == 0b000100000101 => Inst::Wfi {
                    rd,
                    rs1,
                    imm: sext(imm as u64, 11) as i64,
                },
    ...
    pub fn run(self, vm: &mut VM) -> Result<(), VMRunError> {
        match self {
            ...
            Inst::SfenceVma { rd, rs1, rs2 } => SfenceVma::run(vm, rd, vm.x(rs1), vm.x(rs2)),
            ...
            Inst::Fence { rd, rs1, imm } => Fence::run(vm, rd, vm.x(rs1), imm),
            Inst::FenceI { rd, rs1, imm } => FenceI::run(vm, rd, vm.x(rs1), imm),
            Inst::Csrrw { rd, rs1, imm } => Csrrw::run(vm, rd, vm.x(rs1), imm),
            Inst::Csrrs { rd, rs1, imm } => Csrrs::run(vm, rd, vm.x(rs1), imm),
            Inst::Csrrc { rd, rs1, imm } => Csrrc::run(vm, rd, vm.x(rs1), imm),
            Inst::Csrrwi { rd, rs1, imm } => Csrrwi::run(vm, rd, vm.x(rs1), imm),
            Inst::Csrrsi { rd, rs1, imm } => Csrrsi::run(vm, rd, vm.x(rs1), imm),
            Inst::Csrrci { rd, rs1, imm } => Csrrci::run(vm, rd, vm.x(rs1), imm),
            Inst::Ecall { rd, rs1, imm } => Ecall::run(vm, rd, vm.x(rs1), imm),
            Inst::Ebreak { rd, rs1, imm } => Ebreak::run(vm, rd, vm.x(rs1), imm),
            Inst::Uret { rd, rs1, imm } => Uret::run(vm, rd, vm.x(rs1), imm),
            Inst::Sret { rd, rs1, imm } => Sret::run(vm, rd, vm.x(rs1), imm),
            Inst::Mret { rd, rs1, imm } => Mret::run(vm, rd, vm.x(rs1), imm),
            Inst::Wfi { rd, rs1, imm } => Wfi::run(vm, rd, vm.x(rs1), imm),
