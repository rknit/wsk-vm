use crate::bits::{
    funct7_31_25, imm_32_20, rd_11_7, rs1_19_15, rs2_24_20, sext, sext_imm_12, sext_imm_13,
    sext_imm_21,
};
use crate::{RunInst, ext};

#[inline]
pub fn r(f: impl Fn(usize, usize, usize) -> Box<dyn RunInst>, inst32: u32) -> Box<dyn RunInst> {
    f(rd_11_7(inst32), rs1_19_15(inst32), rs2_24_20(inst32))
}

#[inline]
pub fn i(f: impl Fn(usize, usize, i64) -> Box<dyn RunInst>, inst32: u32) -> Box<dyn RunInst> {
    f(rd_11_7(inst32), rs1_19_15(inst32), imm_32_20(inst32))
}

#[inline]
pub fn s(f: impl Fn(usize, usize, i64) -> Box<dyn RunInst>, inst32: u32) -> Box<dyn RunInst> {
...
#[inline]
pub fn b(f: impl Fn(usize, usize, i64) -> Box<dyn RunInst>, inst32: u32) -> Box<dyn RunInst> {
...
#[inline]
pub fn u(f: impl Fn(usize, i64) -> Box<dyn RunInst>, inst32: u32) -> Box<dyn RunInst> {
...
#[inline]
pub fn j(f: impl Fn(usize, i64) -> Box<dyn RunInst>, inst32: u32) -> Box<dyn RunInst> {
